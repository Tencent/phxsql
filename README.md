...
|测试集群 |Client线程数 |insert.lua (100%写) QPS |select.lua （0%写) QPS |OLTP.lua(25%写) QPS|
|---------| ------------| --------------|---------------|-------------------|
| PhxSQL  |   200       | 5197          |	46334	        | 26133             |
| MySQL半同步| 200      | 3869          | 47528         | 19927             |
| PhxSQL  |   500       | 8779          |	105928	      | 46066             |
| MySQL半同步| 500      | 6824          | 121535        | 33334             |
